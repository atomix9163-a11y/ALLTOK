...
function fn_checkByteString(text_val){
    const text_len = text_val.length; //입력한 문자수
...
const openWindow = (query, w, h, scroll) => {
...
const makeNumberInput = (elements) => {
...
const maskPhoneNumber = (phoneNumber) => {
    ...
    if (cleaned.length === 10) {
      ...
      return phoneNumber; // 포맷이 다르면 원본 반환
    }
}