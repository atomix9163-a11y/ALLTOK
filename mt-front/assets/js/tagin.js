...
(function (global, factory) {
    ...
    class Tagin {
        ...
        constructor(inputElement, options) {
            ...
            this.enterFunc = options?.enterFunc;
            this.createWrapper();
            this.autowidth();
        ...
        clear() {            
            let existItems = this.wrapper.getElementsByClassName(this.classTag);
            
            for(var i=existItems.length-1;i >= 0;i--){
                var childNode = existItems[i];
